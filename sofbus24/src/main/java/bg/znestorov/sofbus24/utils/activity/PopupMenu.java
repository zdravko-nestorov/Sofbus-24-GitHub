 ...
 * or above it if there is not. If the IME is visible the popup will not overlap
 * it until it is touched. Touching outside of the popup will dismiss it.
 */
public class PopupMenu implements MenuBuilder.Callback, MenuPresenter.Callback {
     ...
     * @param anchor  Anchor view for this popup. The popup will appear below the
     ...
     * calling popupMenu.getMenuInflater().inflate(menuRes,
     * popupMenu.getMenu()).
     *
